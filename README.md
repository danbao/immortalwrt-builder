...
构建默认使用 ImmortalWrt 25.12.1 的 `x86/generic` ImageBuilder。第三方组件统一选用 OpenWrt 25.12 对应的 APK 资产；官方仓库签名仍由 ImageBuilder 自带密钥校验，本地附加 APK 会由 ImageBuilder 建立并签署独立索引。
