...
Bump `BUILDER_VERSION` in `scripts/openwrt_img_to_ova.py` whenever conversion logic or release tag semantics change, so earlier manifest entries are not reused incorrectly.
